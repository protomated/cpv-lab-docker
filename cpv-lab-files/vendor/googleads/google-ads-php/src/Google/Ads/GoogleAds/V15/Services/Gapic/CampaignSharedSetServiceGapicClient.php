 ...
 * \Google\Ads\GoogleAds\V15\Services\Client\CampaignSharedSetServiceClient} to use
 * the new surface.
 */
class CampaignSharedSetServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v15.services.CampaignSharedSetService';
