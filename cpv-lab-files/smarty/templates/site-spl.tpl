...
{else}
    ...
    <link rel="stylesheet" type="text/css" href="style-spl/css/spl-style.css?v=1126"/>
  ...
  <link rel="stylesheet" href="style-spl/css/icons.css?v=1126"/>
	...
	<link rel="stylesheet" href="style-spl/css/{$menuLayoutFile|default:''}sidemenu.css?v=1126"/>
	<link rel="stylesheet{if (!$darkmode)} alternate{/if}" type="text/css" href="style-spl/css/dark-sidemenu.css?v=1126" linkscope="dark"/>
  ...
  <link rel="stylesheet{if (!$darkmode)} alternate{/if}" href="style-spl/plugins/sumoselect/dark-sumoselect.css?v=1126" linkscope="dark"/>
	...
	<link rel="stylesheet" href="style-spl/css/placeholder-loading.min.css?v=1126"/>
  
    <!--intro js tour css-->
	<link rel="stylesheet" href="style-spl/plugins/introjs/introjs.min.css?v=1126"/>
{/if}
</head>
<body class="app{if ($darkmode)} dark-mode{/if}">
  ...
  <div class="main-wrapper">
    ...
    <nav class="navbar navbar-expand-lg main-navbar" role="navigation">
      ...
      <div class="form-inline mr-auto">
        ...
        <a href="campaign-add.php" class="btn btn-info btnNewCampaign"><i class="fa fa-plus btnNewCampaign"></i> New Campaign</a>
        {/if}
			</div>
      ...
      <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown dropdown-list-toggle d-block">
          <a href="javascript:;" class="nav-link nav-link-lg">
              <!--<i class="fe fe-sun d-inline-block" id="#" alt="Light Mode"></i>-->
...
{else}
	...
	<!--<script src="style-spl/plugins/nicescroll/jquery.nicescroll.min.js"></script>-->
	...
	<!--<script src="style-spl/plugins/p-scroll/p-scroll.js?v=1126"></script>-->
    <!--Sidemenu js-->
  ...
  <script src="style-spl/plugins/introjs/intro.min.js?v=1126"></script>
    ...
    <!--Scripts js-->
    <script src="style-spl/js/scripts.js?v=1126"></script>
